...
class WebhookPayload:
    ...
    def __init__(
        ...
        self.bob_service_url = bob_service_url
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # Include Bob service URL in metadata for callbacks
        if self.bob_service_url:
            payload["bob_service_url"] = self.bob_service_url
        return payload
...
class WebhookService(BaseService):
    ...
    def __init__(self, ctx: AppContext, bob_service_url: str | None = None) -> None:
        super().__init__(ctx)
        self._bob_service_url = bob_service_url
        self._http_client: Any | None = None

    @property
    def bob_service_url(self) -> str | None:
        """Get the Bob service URL, falling back to settings if not provided."""
        if self._bob_service_url is not None:
            return self._bob_service_url
    ...
    async def trigger_event(
        ...
        resolved_url = bob_service_url or self.bob_service_url
