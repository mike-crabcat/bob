...
import server.services.calendar_service as calendar_service_module
import server.services.notification_service as notification_service_module
import server.services.openclaw_hook_service as openclaw_hook_service_module
import server.services.task_service as task_service_module
...
def test_openclaw_gateway_transport_uses_backend_handshake_and_connect_challenge(
    ...
    db = Database(settings.db_path, Path(__file__).resolve().parents[1] / "server" / "schemas")
