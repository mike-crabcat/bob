-- Add 'task_retry' notification type for submission rejections.

DROP TABLE IF EXISTS notifications_v4;
CREATE TABLE notifications_v4 (
    id TEXT PRIMARY KEY,
    entity_type TEXT NOT NULL CHECK (entity_type IN ('task', 'project', 'event')),
    entity_id TEXT NOT NULL,
    notification_type TEXT NOT NULL CHECK (
        notification_type IN ('needs_input', 'event_reminder', 'task_assignment', 'task_result', 'project_result', 'task_retry')
    ),
