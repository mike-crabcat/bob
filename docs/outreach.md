...
5. Stores the sent message in the target session history
6. Upserts the target contact as a participant
...
5. Adds the `finish_outreach` tool to the agent's toolset
...
- **DM**: `agent:main:whatsapp:dm:61412345678` (phone digits)
