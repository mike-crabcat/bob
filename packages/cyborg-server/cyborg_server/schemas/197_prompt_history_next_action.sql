-- Add next_action to prompt_history category CHECK constraint

DROP TABLE IF EXISTS prompt_history_v3;
CREATE TABLE prompt_history_v3 (
    id TEXT PRIMARY KEY,
...
INSERT OR IGNORE INTO prompt_history_v3
...
ALTER TABLE prompt_history_v3 RENAME TO prompt_history;
