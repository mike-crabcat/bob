...
sys.path.insert(0, "packages/cyborg-server")
...
async def main():
    ...
    schema_dir = Path("packages/cyborg-server/cyborg_server/schemas")
    ...
    from cyborg_server.evals.registry import get_cases_by_category
